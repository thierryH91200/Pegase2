            ...
            ScrollView {
                if model.acknowledgements.isEmpty {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ForEach(model.acknowledgements, id: \.identity) { acknowledgement in
...
final class AcknowledgementWindowController: NSWindowController {
    ...
    deinit {
        print("Acknowledgement window controller de-init'd")
...
struct Acknowledgements_Previews: PreviewProvider {
    static var previews: some View {
        AcknowledgementsView([
            Dependency(identity: "Hi", location: "Test", version: "1.2.3"),
            Dependency(identity: "Hi", location: "Test", version: "1.2.3"),
            Dependency(identity: "Hi", location: "Test", version: "1.2.3"),
            Dependency(identity: "Hi", location: "Test", version: "1.2.3"),
            Dependency(identity: "Hi", location: "Test", version: "1.2.3")
