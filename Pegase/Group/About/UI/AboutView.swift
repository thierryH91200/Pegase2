...
public struct AboutView: View {
    ...
    private var topMetaData: some View {
        VStack(alignment: .leading, spacing: 5) {
            Text("Pegase").font(.system(size: 38, weight: .regular))
    ...
    private var actionButtons: some View {
        HStack {
            ...
            Button {
                guard let url = URL(string: "https://github.com/thierryH91200/Pegase/blob/main/license")
                else { return }
                openURL(url)
            } label: {
